...
Vamos compilar um exemplo simples para testar o `nvcc`. Carreque o arquivo [exemplo1.cu](files/exemplo1-criacao-iteracao.cu) no colab, compile e crie um executável, usando o comando:
